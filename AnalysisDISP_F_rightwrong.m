function EYE = AnalysisDISP_F_rightwrong(directions, results, raw_position, range) 
...
% ROC analysis
    [Xr,Yr,T,AUC(i)] = perfcurve(int2str(dir'),abs((dataF(:,stop_index)-dataF(:,start_index))-mean((dataF(:,stop_index)-dataF(:,start_index)))),'2');
% figure
